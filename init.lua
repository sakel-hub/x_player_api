...
x_player_api.register_model("character.b3d", {
	...
	animations_glb = {
		...
		attack_slash  = {track = "attack_slash", priority = 1, is_action = true, loop = false, speed = 1.0},
		attack_thrust = {track = "attack_thrust", priority = 1, is_action = true, loop = false, speed = 1.0},
